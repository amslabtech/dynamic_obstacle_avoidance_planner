...
gnome-terminal -e "docker exec -it ros_mpc /bin/bash -c 'ldconfig && source /root/catkin_ws/devel/setup.bash && /opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner load_param_fwdis.launch'" --geometry=45x12+0+0 &
sleep 1.0s
...
#gnome-terminal -e "docker exec ros_mpc /bin/bash -c 'ldconfig && source /root/catkin_ws/devel/setup.bash && /opt/ros/kinetic/bin/rosrun dynamic_obstacle_avoidance_planner obstacle_trajectory_predictor_kf'" --geometry=45x12+0+250 &
sleep 0.1s
...
gnome-terminal -e "docker exec ros_mpc /bin/bash -c 'ldconfig && source /root/catkin_ws/devel/setup.bash && /opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner fwdis_mpc.launch'" --geometry=45x12+895+476 &
sleep 0.1s
