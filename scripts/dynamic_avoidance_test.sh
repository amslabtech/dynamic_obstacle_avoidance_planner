...
gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner load_param_dynamic_avoidance.launch" --geometry=45x12+0+0 &
sleep 1.0s
gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner load_param_diff_drive.launch" --geometry=45x12+0+0 &
sleep 1.0s
...
# robot sim
gnome-terminal -e "/opt/ros/kinetic/bin/rosrun dynamic_obstacle_avoidance_planner sim_3dof.py" --geometry=45x12+895+0 &
sleep 0.1s
...
gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner dynamic_local_costmap.launch" --geometry=45x12+1315+250 &
sleep 0.1s

gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner avoidance_path_planner.launch" --geometry=45x12+0+476 &
sleep 0.1s

# for test
gnome-terminal -e "/opt/ros/kinetic/bin/rosrun dynamic_obstacle_avoidance_planner waypoints_test" --geometry=45x12+475+476 &
sleep 0.1s

gnome-terminal -e "/opt/ros/kinetic/bin/roslaunch dynamic_obstacle_avoidance_planner diff_drive_mpc.launch" --geometry=45x12+895+476 &
sleep 0.1s
...
#gnome-terminal -e "/opt/ros/kinetic/bin/rosrun dynamic_obstacle_avoidance_planner trajectory_logger" --geometry=45x12+475+702 &
sleep 0.1s
