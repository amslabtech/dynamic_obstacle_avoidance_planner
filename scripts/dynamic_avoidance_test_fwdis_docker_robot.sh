...
gnome-terminal -e "docker exec ros_mpc /bin/bash -c 'ldconfig && source /root/catkin_ws/devel/setup.bash && /opt/ros/kinetic/bin/rosrun dynamic_obstacle_avoidance_planner base_costmap'" --geometry=45x12+1315+476 &
sleep 0.1s
